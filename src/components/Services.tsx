  ...
  const services = [
    {
      ...
      title: 'SaaS MVPs',
      description:
        'Full-stack web applications that validate your business idea and attract early customers',
    },
    {
      icon: <Smartphone className="w-6 h-6" />,
      title: 'Mobile & Web Apps',
      description:
        'Cross-platform applications that work seamlessly across all devices and platforms',
    },
    {
      icon: <Bot className="w-6 h-6" />,
      title: 'AI Integrations',
      description:
        'Smart features powered by machine learning to give your product a competitive edge',
    },
    /*{
  ...
  const processSteps = [
    {
      ...
      description:
        'We start with a deep dive into your vision, goals, and target market to create a comprehensive technical roadmap.',
      duration: 'Week 1',
    },
    {
      ...
      description:
        'Our team designs the system architecture, user experience, and technical specifications for optimal performance.',
      duration: 'Week 2-3',
    },
    {
      ...
      description:
        'We build your MVP using modern technologies, with continuous testing and feedback integration throughout.',
      duration: 'Week 4-8',
    },
    {
      ...
      title: 'Launch & Scale',
      description:
        'Deploy your product to production with monitoring, analytics, and ongoing support for future growth.',
      duration: 'Week 9+',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From initial concept to production-ready application, we provide
            comprehensive technical expertise every step of the way.
          </p>
        </motion.div>
